package com.xh.dms.core.changelog.model;
...
import com.xh.dms.core.changelog.evt.CReqAppChangeLogEvt;
...
public class ReqAppChangeLog extends AbstractAnnotatedAggregateRoot{
	...
	/**
	 * @param cmd
	 * @see com.xh.dms.core.changelog.model.ReqAppChangeLog#onCReqAppChangeLogEvt(CReqAppChangeLogEvt)
	 */
	@CommandHandler
